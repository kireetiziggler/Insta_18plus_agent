...
async function extract() {
  const reelPath = 'c:/Users/kiree/OneDrive/Documents/Insta_agent/data/posts/reel_sassy_1780461192060/reel.mp4';
  ...
  try {
    ...
    console.log('Extracting screenshot from reel.mp4 at t=24s...');
    await runCommand(`"${ffmpegPath}" -y -ss 00:00:24 -i "${reelPath}" -vframes 1 "${outPath2}"`);

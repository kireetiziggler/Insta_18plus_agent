...
- audioScript: The text narration for the voiceover. It must describe the full story in vivid detail, using double quotes for spoken parts. STRICT LENGTH LIMIT: Maximum 40-55 words (approximately 13 seconds when read aloud at a natural pace). This is a hard limit — the Reel is exactly 15 seconds total (13s content + 2s CTA). It must sound like a real person sharing a raw, direct secret/confession (no greetings like "Hey everyone!", no formal AI buzzwords, no robotic sign-offs, no questions at the end). Write 3-4 short punchy sentences with natural emotional pauses. Do not include markdown, stage directions, or audio cues.
